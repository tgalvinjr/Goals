...
export class GoalComponent implements OnInit {
  ...
  goals = [
    ...
    new Goal(4, 'Get Dog Food', 'Pupper likes expensive sancks', new Date(1992, 0, 29)),
    new Goal(5, 'Solve math homework', 'Damn Math', new Date(2016, 9, 9)),
    new Goal(6, 'Plot my world domination plan', 'Cause I am an evil overlord', new Date(1994, 8, 15)),
